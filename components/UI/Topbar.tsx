...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-sm border-b border-gray-100 px-4 h-14 flex items-center justify-between shrink-0">
      ...
      <div ref={searchRef} className="relative flex-1 max-w-md">
        ...
        {searchOpen && query.trim() && (
          <div className="absolute left-0 right-0 top-full mt-2 bg-white rounded-xl border border-gray-100 shadow-lg py-2 z-50">
              ...
              searchResults.slice(0, 6).map((inv) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 truncate">{inv.bill_to.name || "—"}</p>
                  </div>
                </button>
              ))
            )}
      ...
      <div className="flex items-center gap-2 ml-4">
        ...
        <div ref={notifRef} className="relative">
          ...
          {notifOpen && (
            <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl border border-gray-100 shadow-lg py-2 z-50">
