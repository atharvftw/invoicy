  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 overflow-y-auto min-w-0">
        {/* Topbar */}
        <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-sm border-b border-gray-100 px-3 sm:px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            {/* Preview toggle — desktop only (preview panel hidden on mobile) */}
            <button
              onClick={togglePreview}
              className="hidden lg:flex p-2 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors"
            ...
            <button
              onClick={handleSave}
              className={`flex items-center gap-1.5 px-2.5 sm:px-4 py-2 rounded-lg text-sm font-medium transition-all duration-150 ${
                saved
